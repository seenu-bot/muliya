...
const goldCategories = [
  { name: "Gold Necklaces", desc: "Layered chains, temple sets, coin necklaces, and more in 22K gold", icon: "📿" },
  { name: "Gold Bangles", desc: "Plain, engraved, and stone-studded bangles in 22K and 18K", icon: "💛" },
  { name: "Gold Rings", desc: "Daily-wear to statement rings crafted for every occasion", icon: "💍" },
  { name: "Gold Earrings", desc: "Studs, hoops, jhumkas, and chandbalis in pure gold", icon: "✨" },
  { name: "Gold Bracelets", desc: "Classic and contemporary bracelets for men and women", icon: "⭐" },
  { name: "Bridal Gold Sets", desc: "Complete wedding sets with matching necklace, bangles & earrings", icon: "👑" },
];

const whyUs = [
  { icon: <Shield className="w-6 h-6 text-[#E92247]" />, title: "BIS Hallmarked Gold", desc: "Every piece is hallmarked and certified for purity" },
  { icon: <Award className="w-6 h-6 text-[#E92247]" />, title: "Transparent Pricing", desc: "Live gold rate pricing with zero hidden making charges" },
  { icon: <Star className="w-6 h-6 text-[#E92247]" />, title: "Expert Craftsmen", desc: "Skilled artisans with 30+ years of goldsmithing heritage" },
];

const faqs = [
  {
    q: "Where is the best gold jewellery shop in Central Bangalore?",
    a: "Muliya Gold & Diamonds at Manipal Centre, Sivanchetti Gardens — just off MG Road — is one of Central Bangalore's most trusted gold jewellery showrooms with 30+ years of heritage.",
  },
  {
    q: "What types of gold jewellery are available at your Central Bangalore showroom?",
    a: "We stock 22K and 18K gold necklaces, bangles, rings, earrings, bracelets, chains, and complete bridal gold sets. We also offer custom gold jewellery making.",
  },
  {
    q: "Is the gold jewellery in your Central Bangalore shop BIS hallmarked?",
    a: "Yes, every piece of gold jewellery at our showroom is BIS hallmarked, ensuring certified purity as per Indian government standards.",
  },
  {
    q: "What is the nearest metro station to your gold shop in Central Bangalore?",
    a: "The closest metro station is Cubbon Park Metro (Purple Line) and MG Road Metro, both within 5–10 minutes walking distance from our Sivanchetti Gardens showroom.",
  },
  {
    q: "Do you offer gold exchange or buyback at your Central Bangalore showroom?",
    a: "Yes, we offer gold exchange and buyback at fair live market rates. Visit our showroom or call us to know more.",
  },
];

export default function CentralBangalorePage() {
  return (
    <main className="min-h-screen bg-white font-sans">
      ...
      <section className="relative bg-[#E92247] overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <nav className="flex items-center gap-2 text-sm text-white/70 mb-8 justify-center">
            ...
            <ChevronRight className="w-3 h-3" />
            <span className="text-white">Central Bangalore</span>
          </nav>
          <div className="text-center max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10">
              ...
              >
                <Navigation className="w-5 h-5" /> Find Our Store
              </a>
              <a
        ...
        <div className="bg-white rounded-2xl shadow-2xl overflow-hidden">
          <div className="grid md:grid-cols-2">
            <div className="relative h-72 md:h-auto min-h-[300px]">
              <Image src={store.image} alt="Gold jewellery shop Central Bangalore Muliya" fill className="object-cover" />
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif text-gray-900 mb-4">
              Explore Our Gold Jewellery Collections
            </h2>
            <div className="w-16 h-0.5 bg-[#E92247] mx-auto" />
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {goldCategories.map((c) => (
      ...
      <section className="bg-gray-900 text-white py-16 md:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-3xl md:text-4xl font-serif mb-4">Visit Our Gold Shop in Central Bangalore</h2>
          <p className="text-gray-400 mb-8 text-lg max-w-xl mx-auto">
            Shop BIS hallmarked gold jewellery with complete transparency and personalised service at our Central Bangalore showroom.
          </p>

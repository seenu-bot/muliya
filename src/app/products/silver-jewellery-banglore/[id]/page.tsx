...
export default function SilverProductDetailPage() {
    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <Link href="/products/silver-jewellery-banglore" className="text-[#E92247] hover:underline">← Back to Silver Collection</Link>
        </div>
      </main>
    );
  }
  ...
  const handleAddToCart = () => {
    addToCart({ 
      ...
      collectionSlug: "silver-jewellery-banglore" 
    });
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <Link href="/products/silver-jewellery-banglore" className="hover:text-[#E92247] transition-colors">Silver</Link>
            <ChevronRight className="w-4 h-4" />
            <Link href={`/products/silver-jewellery-banglore#${product.subcategory.toLowerCase()}`} className="hover:text-[#E92247] transition-colors">{product.subcategory}</Link>
            <ChevronRight className="w-4 h-4" />
          ...
          <div className="space-y-6">
            <div>
              <div className="flex items-center gap-2 mb-2">
                ...
                <Link href={`/products/silver-jewellery-banglore#${product.subcategory.toLowerCase()}`} className="text-gray-500 text-sm hover:text-[#E92247] transition-colors">{product.subcategory}</Link>
              </div>

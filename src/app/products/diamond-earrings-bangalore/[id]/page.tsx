...
export default function DiamondEarringDetailPage() {
    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <Link href="/products/diamond-earrings-bangalore" className="text-[#E92247] hover:underline">← Back to Diamond Earrings</Link>
        </div>
      </main>
    );
  }
  ...
  const handleAddToCart = () => {
    addToCart({ id: product.id, name: product.name, price: product.price, originalPrice: product.originalPrice, image: product.image, collection: product.category, collectionSlug: "diamond-earrings-bangalore" });
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900 font-medium">5.2g</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Diamond Value</span>
                <span className="text-gray-900 font-medium">Rs. 32,000</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Making Charges</span>
                <span className="text-gray-900 font-medium">Rs. 6,000</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">GST (3%)</span>
                <span className="text-gray-900 font-medium">Rs. 1,290</span>
              </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900 font-medium">0.38 ct</span>
                </li>
                <li className="flex justify-between text-sm">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900 font-medium">0.18 ct</span>
                  </li>
                  <li className="flex justify-between text-sm">
                    <span className="text-gray-600">Color</span>

...
export default function DiamondNecklaceDetailPage() {
    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <Link href="/products/diamond-necklace-banglore" className="text-[#E92247] hover:underline">← Back to Diamond Necklaces</Link>
        </div>
      </main>
    );
  }
  ...
  const handleAddToCart = () => {
    addToCart({ id: product.id, name: product.name, price: product.price, originalPrice: product.originalPrice, image: product.image, collection: product.category, collectionSlug: "diamond-necklace-banglore" });

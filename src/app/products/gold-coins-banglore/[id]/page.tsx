    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <Link href="/products/gold-coins-banglore" className="text-[#E92247] hover:underline">← Back to Gold Coins</Link>
        </div>
      </main>
    );
  }
      ...
      <div className="bg-gray-50 border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <nav className="flex items-center gap-2 text-sm text-gray-600">
            ...
            <Link href="/products/gold-rings-banglore" className="hover:text-[#E92247] transition-colors">Gold</Link>
            <ChevronRight className="w-4 h-4" />
            <Link href="/products/gold-coins-banglore" className="hover:text-[#E92247] transition-colors">Gold Coins</Link>
            <ChevronRight className="w-4 h-4" />

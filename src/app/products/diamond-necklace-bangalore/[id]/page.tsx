...
export default function DiamondNecklaceDetailPage() {
    ...
    return (
      <main className="min-h-screen bg-white">
        <div className="max-w-7xl mx-auto px-4 py-16 text-center">
          ...
          <Link href="/products/diamond-necklace-bangalore" className="text-[#E92247] hover:underline">← Back to Diamond Necklaces</Link>
        </div>
      </main>
    );
  }
  ...
  const handleAddToCart = () => {
    addToCart({ id: product.id, name: product.name, price: product.price, originalPrice: product.originalPrice, image: product.image, collection: product.category, collectionSlug: "diamond-necklace-bangalore" });
          ...
          <div className="bg-gray-50 rounded-xl p-6">
            <div className="space-y-3">
              ...
              <div className="flex justify-between text-sm">
                ...
                <span className="text-gray-900 font-medium">12.8g</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Diamond Value</span>
                <span className="text-gray-900 font-medium">Rs. 68,000</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">Making Charges</span>
                <span className="text-gray-900 font-medium">Rs. 12,000</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-gray-600">GST (3%)</span>
                <span className="text-gray-900 font-medium">Rs. 2,730</span>
              </div>
            ...
            <div className="bg-gray-50 rounded-xl p-6">
              ...
              <ul className="space-y-3">
                ...
                <li className="flex justify-between text-sm">
                  ...
                  <span className="text-gray-900 font-medium">1.24 ct</span>
                </li>
                <li className="flex justify-between text-sm">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900 font-medium">0.82 ct</span>
                  </li>
                  <li className="flex justify-between text-sm">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex justify-between text-sm">
                    ...
                    <span className="text-gray-900 font-medium">0.42 ct</span>
                  </li>
                  <li className="flex justify-between text-sm">
                    <span className="text-gray-600">Color</span>
